...
import type { TutorialSection } from '@/types/landing/tutorial-section'

export default function TutorialSection({ data }: { data: TutorialSection }) {
  ...
  useGSAP(() => {
    const { section, video, wrapper, text, boxes } = {
      section: sectionAbout.current,
